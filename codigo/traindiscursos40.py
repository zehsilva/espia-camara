...
corpus = topicdetect.loadCorpus('-completedic-discursos-sample30-nostem')
dirmodel = '/home/msc/eliezers/Dropbox/dados_deputados/'

print 'treinando LDA'
lda = gensim.models.ldamodel.LdaModel(corpus=corpus, id2word=dictionary, num_topics=300, update_every=0, passes=20)
lda.save(dirmodel+'model-lda-discursos-complete-nostemm-sample30-100topics.lda')
